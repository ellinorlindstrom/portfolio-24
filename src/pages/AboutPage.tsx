...
function AboutPage() {
  return (
    ...
    <h2 className='about-page-title'>
        ...
        I’m a <span className='italic'>curious</span> and <span className='bold'>enthusiastic</span> developer with an intereset in UX, motion- and interactive designs.💫 <br />
